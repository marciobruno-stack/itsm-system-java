...
-- Inserir utilizadores (password: "password123" com BCrypt)
...
INSERT INTO tecnico (utilizador_id, disponibilidade, carga_trabalho_atual) VALUES
                                                                               (2, '{"segunda":["09:00-18:00"],"terca":["09:00-18:00"],"quarta":["09:00-18:00"]}', 0),
                                                                               (3, '{"segunda":["10:00-19:00"],"quinta":["10:00-19:00"],"sexta":["10:00-19:00"]}', 0);

-- Competências
INSERT INTO competencia (nome) VALUES ('Redes'), ('Windows Server'), ('Linux'), ('SQL'), ('Java');

-- Associação técnico-competência
